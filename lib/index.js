...
function convert(line) {
  ...
  var xmlNode = '<note>';
  xmlNode += '<title>' + title + '</title><content><![CDATA[<?xml version=\'1.0\' encoding=\'UTF-8\'?><!DOCTYPE en-note SYSTEM \'http://xml.evernote.com/pub/enml2.dtd\'><en-note>' + title + '<br /><a href="' + uri + '">' + uri + '</a></en-note>]]></content>';
